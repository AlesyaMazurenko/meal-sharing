...
VALUES 
(1, 'meal quality', 'The quality of material, taste and freshness was excellent', 1, 5, '2024-02-01'),
(2, 'cleanness', 'The host''s house and kitchen were clean and the meal was good but a little bit salty', 4, 4, '2024-02-02'),
(3, 'Too spicy', 'Our burgers didn''t tase good and there were too spicy for me', 3, 3, '2024-02-03'),
(4, 'so delicious', 'Our meal was perfect', 5, 5, '2024-02-04');
...
UPDATE meal
SET `title` = 'grilled chiken', `location` = 'Aarhus', `max_reservations`=50, description='grilled chiken, lettuce, tomato, rooster sauce, brioche bun'
WHERE `id`=7;

UPDATE meal set `img`='https://images.unsplash.com/photo-1586816001966-79b736744398?q=80&w=2940&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
where `id`=1;
...
ALTER TABLE meal ADD img VARCHAR(225);

UPDATE meal
SET `img` = 'https://images.unsplash.com/photo-1590498403794-fd0ebd0db70c?q=80&w=2787&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
WHERE id=7;

SELECT id, img, title from meal;